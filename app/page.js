  ...
  return (
    <div className="font-sans bg-white text-gray-800">
      ...
      <section className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-r from-purple-600 to-indigo-600 text-white text-center px-6">
        <h1 className="text-4xl md:text-6xl font-bold mb-4">High Pressure Checker</h1>
        ...
        <form className="w-full max-w-md flex flex-col md:flex-row gap-3">
          ...
          <button
            type="submit"
            className="bg-white text-indigo-600 font-semibold py-3 px-6 rounded-full shadow hover:bg-gray-100 transition"
          >
            Sign Up
          </button>
        </form>
